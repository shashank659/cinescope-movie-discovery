...
import { UserPlus, AlertCircle, Film } from 'lucide-react';
...
export const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto py-12 px-4" data-testid="register-page">
      <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-neutral-400">
            Join CineScope to save movies to your watchlist and track favorites.
          </p>
        </div>
        ...
        <div className="text-center text-xs text-neutral-400 pt-2 border-t border-neutral-800">
          ...
          <Link to="/login" className="text-purple-400 hover:text-purple-300 font-medium transition underline">
            Sign in
          </Link>
        </div>
      </div>
